...
\end{block}}
\visible<3->{
\textbf{Remarks}: $-\infty$ penalty on constraints violations $\Rightarrow$ safe policy (mathematically) }
\begin{columns}
\column{0.5\textwidth}
\visible<3->{
\begin{itemize}
...
\end{itemize}
\column{0.5\textwidth}
\includegraphics[width=1\textwidth]{Codes/BasicsSafety/PessimisticModelSTEPBOXED7.eps}
\end{columns}
